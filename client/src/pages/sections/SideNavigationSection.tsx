...
export const SideNavigationSection = (): JSX.Element => {
  ...
  return (
    <nav className="flex w-[272px] items-start relative bg-gray-100 border-r-[3px] border-r-gray-100 border-solid flex-shrink-0 sticky top-0 h-full z-30" data-testid="side-navigation">

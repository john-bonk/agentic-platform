...
export const HeaderSection = (): JSX.Element => {
  const getIcon = (iconName: string) => {
    switch (iconName) {
      case "x":
        return <XIcon className="w-3 h-3 text-slate-400" />;
      case "pin":
        return <PinIcon className="w-3 h-3 text-slate-400" />;
      case "settings":
        return <SettingsIcon className="w-3 h-3 text-slate-400" />;
      case "files":
        return <FilesIcon className="w-3 h-3 text-slate-400" />;
      case "plug":
        return <PlugIcon className="w-3 h-[12.5px] text-slate-400" />;
      case "bot":
        return <BotIcon className="w-4 h-4 text-slate-400" />;
      case "clock":
        return <ClockIcon className="w-4 h-4 text-slate-400" />;
      case "mail":
        return <MailIcon className="w-4 h-4 text-slate-400" />;
      case "bell":
  ...
  return (
    <header className="flex h-12 items-end justify-between pl-0 pr-2 py-0 w-full bg-slate-900">
      ...
      <div className="inline-flex items-center justify-end gap-3 h-full flex-[0_0_auto]">
        <div className="inline-flex items-center gap-1 flex-[0_0_auto]">
          {utilityIcons.map((item, index) => (
            <Button
              ...
              variant="ghost"
              size="icon"
              className="w-10 h-10 rounded hover:bg-slate-800"
        ...
        <Button
          variant="ghost"
          className="inline-flex h-10 items-center justify-center gap-[3px] flex-[0_0_auto] rounded hover:bg-slate-800 h-auto px-0"

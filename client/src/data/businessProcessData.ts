    ...
    processes: [
      {
        ...
        dependencies: {
          itAssets: [
            { name: "AWS Cloud Infrastructure", description: "Primary cloud hosting platform with EC2, ECS, and Lambda services", recoveryTimeframe: "15 mins", recoveryGap: "met", assetOwner: "Marcus Chen" },
            { name: "Kubernetes Cluster", description: "Container orchestration platform running 200+ microservices", recoveryTimeframe: "30 mins", recoveryGap: "met", assetOwner: "Marcus Chen" },
            ...
            { name: "Azure Cloud Services", description: "Secondary cloud provider for multi-cloud strategy", recoveryTimeframe: "30 mins", recoveryGap: "met", assetOwner: "Marcus Chen" },
            { name: "Cloudflare CDN", description: "Content delivery and DDoS protection", recoveryTimeframe: "10 mins", recoveryGap: "met", assetOwner: "Marcus Chen" },
          ...
          businessProcesses: [
            { name: "Incident Management", description: "Infrastructure incident response and escalation.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Change Management", description: "Infrastructure change coordination and approval.", rto: "4 hours", processOwner: "Marcus Chen" },
            { name: "Security Operations", description: "Infrastructure security monitoring.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Application Support", description: "Application infrastructure dependencies.", rto: "1 hour", processOwner: "Marcus Chen" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            { name: "Infrastructure Management", description: "Infrastructure incident escalation and coordination.", rto: "30 mins", processOwner: "Marcus Chen" },
            { name: "Application Support", description: "Application-level incident coordination.", rto: "1 hour", processOwner: "Marcus Chen" },
            { name: "Security Operations", description: "Security incident escalation path.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Change Management", description: "Emergency change requests during incidents.", rto: "4 hours", processOwner: "Marcus Chen" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            ...
            { name: "Security Operations", description: "Security review for changes.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Quality Assurance", description: "Pre-deployment testing verification.", rto: "4 hours", processOwner: "Priya Sharma" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            { name: "Incident Management", description: "Application incident escalation and response.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Software Deployment", description: "Application update and hotfix coordination.", rto: "2 hours", processOwner: "Priya Sharma" },
            { name: "Infrastructure Management", description: "Application infrastructure support.", rto: "30 mins", processOwner: "Marcus Chen" },
            { name: "Software Development Lifecycle", description: "Bug fix prioritization and development.", rto: "4 hours", processOwner: "Priya Sharma" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          itAssets: [
            { name: "CrowdStrike Falcon", description: "Next-gen endpoint detection and response platform", recoveryTimeframe: "10 mins", recoveryGap: "met", assetOwner: "James Liu" },
            { name: "Okta Identity", description: "Enterprise identity and single sign-on platform", recoveryTimeframe: "15 mins", recoveryGap: "met", assetOwner: "James Liu" },
            { name: "Splunk SIEM", description: "Security event correlation and threat detection", recoveryTimeframe: "30 mins", recoveryGap: "met", assetOwner: "James Liu" },
            ...
            { name: "Palo Alto Firewall", description: "Next-gen firewall and network security", recoveryTimeframe: "15 mins", recoveryGap: "met", assetOwner: "James Liu" },
          ...
          businessProcesses: [
            { name: "Incident Management", description: "Security incident escalation and response.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Infrastructure Management", description: "Security infrastructure protection.", rto: "30 mins", processOwner: "Marcus Chen" },
            { name: "Change Management", description: "Security review for system changes.", rto: "4 hours", processOwner: "Marcus Chen" },
            { name: "Software Development Lifecycle", description: "Secure coding practices and reviews.", rto: "4 hours", processOwner: "Priya Sharma" },
          ],
          branches: [
    ...
    processes: [
      {
        ...
        dependencies: {
          itAssets: [
            { name: "GitHub Enterprise", description: "Enterprise source code repository with advanced security features", recoveryTimeframe: "1 hour", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "Jira", description: "Agile project management and sprint tracking", recoveryTimeframe: "2 hours", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "Confluence", description: "Technical documentation and knowledge base", recoveryTimeframe: "4 hours", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "Figma", description: "Collaborative design and prototyping platform", recoveryTimeframe: "2 hours", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "Slack", description: "Team communication and integration hub", recoveryTimeframe: "10 mins", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "VS Code Remote", description: "Cloud-based development environment", recoveryTimeframe: "30 mins", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "Linear", description: "Issue tracking for product teams", recoveryTimeframe: "1 hour", recoveryGap: "met", assetOwner: "Priya Sharma" },
            { name: "Notion", description: "Product requirements and specs documentation", recoveryTimeframe: "2 hours", recoveryGap: "met", assetOwner: "Priya Sharma" },
          ],
          vendors: [
          ...
          businessProcesses: [
            { name: "Software Deployment", description: "Code release and deployment coordination.", rto: "2 hours", processOwner: "Priya Sharma" },
            { name: "Quality Assurance", description: "Testing and quality validation.", rto: "4 hours", processOwner: "Priya Sharma" },
            { name: "Product Management", description: "Feature requirements and prioritization.", rto: "24 hours", processOwner: "Priya Sharma" },
            { name: "UX Research and Design", description: "Design specifications and handoff.", rto: "8 hours", processOwner: "Priya Sharma" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            ...
            { name: "Quality Assurance", description: "Pre-deployment testing validation.", rto: "4 hours", processOwner: "Priya Sharma" },
            { name: "Infrastructure Management", description: "Deployment infrastructure support.", rto: "30 mins", processOwner: "Marcus Chen" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            { name: "Software Development Lifecycle", description: "Code quality validation and testing.", rto: "4 hours", processOwner: "Priya Sharma" },
            { name: "Software Deployment", description: "Pre-deployment testing gates.", rto: "2 hours", processOwner: "Priya Sharma" },
            { name: "Security Operations", description: "Security testing coordination.", rto: "15 mins", processOwner: "Marcus Chen" },
            { name: "Application Support", description: "Production bug verification.", rto: "1 hour", processOwner: "Marcus Chen" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            ...
            { name: "UX Research and Design", description: "Design collaboration and research.", rto: "8 hours", processOwner: "Priya Sharma" },
            { name: "Quality Assurance", description: "Acceptance criteria validation.", rto: "4 hours", processOwner: "Priya Sharma" },
          ],
          branches: [
      ...
      },
      {
        ...
        dependencies: {
          ...
          businessProcesses: [
            { name: "Product Management", description: "Feature design requirements and validation.", rto: "24 hours", processOwner: "Priya Sharma" },
            { name: "Software Development Lifecycle", description: "Design implementation handoff.", rto: "4 hours", processOwner: "Priya Sharma" },
            { name: "Quality Assurance", description: "Visual and usability testing coordination.", rto: "4 hours", processOwner: "Priya Sharma" },
          ],
          branches: [

            ...
            >
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-sm font-semibold text-gray-900 mb-1" data-testid={`text-objective-title-${objective.id}`}>
                      {objective.title}
                    </h4>
                    <p className="text-xs text-gray-500 line-clamp-1" data-testid={`text-objective-description-${objective.id}`}>
              ...
              <div className="flex items-center gap-4 mb-3">
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-semibold text-gray-700" data-testid={`text-objective-progress-${objective.id}`}>
                      {objective.progress}%
                    </span>
                  </div>
                  <Progress 
              ...
              <div className="flex items-center gap-4 text-xs text-gray-500">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Due: </span>
                  <span className="text-gray-700 font-medium" data-testid={`text-objective-due-${objective.id}`}>
                    {objective.dueDate}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Owner: </span>
                  <span className="text-gray-700 font-medium" data-testid={`text-objective-owner-${objective.id}`}>
                    {objective.owner}
                  </span>
                </div>
              </div>

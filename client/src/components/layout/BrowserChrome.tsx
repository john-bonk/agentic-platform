...
export function BrowserChrome({ children, tabs: externalTabs }: BrowserChromeProps) {
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden" data-testid="browser-chrome-wrapper">
      <div
        ...
        style={{ backgroundColor: '#e8eaed', height: `${BROWSER_CHROME_HEIGHT}px` }}
      ...
      >
          ...
          {tabs.map((tab) => (
            <div
              ...
              className={`flex items-center gap-1.5 h-[30px] px-3 text-xs max-w-[220px] min-w-[120px] rounded-t-lg ${
                tab.isActive
                  ? "bg-white dark:bg-[#292b2f]"
                  : "bg-[#dde1e5] dark:bg-[#3a3d41]"
              }`}
            ...
            >
              ...
              <span className="truncate flex-1 text-[12px] text-gray-700 dark:text-gray-300">
                {tab.label}
              </span>
        ...
        <div
          className="flex items-center h-[32px] px-2 gap-2 bg-white dark:bg-[#292b2f]"
          data-testid="browser-url-bar-row"
        >
          <div className="flex items-center gap-1 flex-shrink-0 px-1">
            <svg className="w-[14px] h-[14px] text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M15 18l-6-6 6-6" />
            </svg>
            <svg className="w-[14px] h-[14px] text-gray-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M9 6l6 6-6 6" />
            </svg>
            <svg className="w-[14px] h-[14px] text-gray-400 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div
            className="flex-1 flex items-center h-[24px] rounded-full px-3 text-[12px] text-gray-500 dark:text-gray-400"
            style={{ backgroundColor: '#f1f3f4' }}
            data-testid="browser-url-bar"
          >
            <svg className="w-[12px] h-[12px] mr-1.5 text-gray-400 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">

...
export class MemStorage implements IStorage {
  ...
  private seedExampleData() {
    ...
    const exampleNodes: WorkflowNode[] = [
      ...
      { id: "wf2-n1", workflowId: "wf2", typeId: "start", label: "Initiate Testing", config: {}, positionX: 100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf2-n2", workflowId: "wf2", typeId: "ab-controls", label: "Fetch Active Controls", config: { action: "query", filters: { status: "active", testingDue: true } }, positionX: 300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf2-n3", workflowId: "wf2", typeId: "loop", label: "For Each Control", config: { iteratorVariable: "control", maxIterations: 100 }, positionX: 500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf2-n4", workflowId: "wf2", typeId: "script", label: "Execute Test Script", config: { language: "javascript", code: "// Run automated control test\nreturn testControl(control.id);" }, positionX: 700, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf2-n5", workflowId: "wf2", typeId: "decision", label: "Test Passed?", config: { conditions: [{ field: "testResult", operator: "equals", value: "passed" }] }, positionX: 900, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf2-n6", workflowId: "wf2", typeId: "ab-controls", label: "Update Status: Effective", config: { action: "update", data: { effectivenessStatus: "effective", lastTestDate: "{{now}}" } }, positionX: 1100, positionY: 50, metadata: {}, createdAt: now },
      { id: "wf2-n7", workflowId: "wf2", typeId: "human-task", label: "Manual Review Required", config: { assignee: "control-tester@company.com", title: "Review Failed Control Test", priority: "high", description: "Control test failed - manual verification needed" }, positionX: 1100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf2-n8", workflowId: "wf2", typeId: "ab-issues", label: "Create Deficiency Issue", config: { action: "create", data: { type: "control-deficiency", severity: "medium", status: "open" } }, positionX: 1300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf2-n9", workflowId: "wf2", typeId: "transform", label: "Compile Results", config: { mapping: { totalTested: "{{count}}", passRate: "{{passed/count * 100}}" } }, positionX: 1100, positionY: 400, metadata: {}, createdAt: now },
      { id: "wf2-n10", workflowId: "wf2", typeId: "email-notification", label: "Send Test Report", config: { to: ["compliance-team@company.com"], subject: "Control Testing Complete - {{passRate}}% Pass Rate" }, positionX: 1300, positionY: 400, metadata: {}, createdAt: now },
      { id: "wf2-n11", workflowId: "wf2", typeId: "end", label: "Complete", config: {}, positionX: 1500, positionY: 250, metadata: {}, createdAt: now },
      
      // WF3: Risk Assessment Pipeline
      { id: "wf3-n1", workflowId: "wf3", typeId: "start", label: "Start Assessment", config: {}, positionX: 100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n2", workflowId: "wf3", typeId: "ab-risks", label: "Fetch Risk Universe", config: { action: "query", filters: { assessmentPeriod: "current" } }, positionX: 300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n3", workflowId: "wf3", typeId: "parallel-gateway", label: "Parallel Assessment", config: { branches: ["inherent", "residual", "controls"] }, positionX: 500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n4", workflowId: "wf3", typeId: "script", label: "Calculate Inherent Risk", config: { language: "javascript", code: "return calculateInherentRisk(risk);" }, positionX: 700, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf3-n5", workflowId: "wf3", typeId: "ab-controls", label: "Evaluate Controls", config: { action: "query", filters: { linkedRiskId: "{{risk.id}}" } }, positionX: 700, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n6", workflowId: "wf3", typeId: "script", label: "Calculate Residual Risk", config: { language: "javascript", code: "return calculateResidualRisk(inherent, controlEffectiveness);" }, positionX: 700, positionY: 400, metadata: {}, createdAt: now },
      { id: "wf3-n7", workflowId: "wf3", typeId: "transform", label: "Merge Scores", config: { mapping: { inherentScore: "{{inherent}}", residualScore: "{{residual}}", controlCoverage: "{{coverage}}" } }, positionX: 900, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n8", workflowId: "wf3", typeId: "decision", label: "Above Tolerance?", config: { conditions: [{ field: "residualScore", operator: "greaterThan", value: 15 }] }, positionX: 1100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n9", workflowId: "wf3", typeId: "approval", label: "Risk Accept Approval", config: { approvers: ["risk-committee@company.com"], requiredApprovals: 2, escalationDays: 5 }, positionX: 1300, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf3-n10", workflowId: "wf3", typeId: "human-task", label: "Develop Mitigation Plan", config: { assignee: "risk-owner@company.com", title: "Create Risk Mitigation Plan", priority: "high", description: "Develop mitigation strategy for high-risk item" }, positionX: 1300, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf3-n11", workflowId: "wf3", typeId: "ab-risks", label: "Update Risk Record", config: { action: "update", data: { assessmentStatus: "complete", lastAssessed: "{{now}}" } }, positionX: 1500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf3-n12", workflowId: "wf3", typeId: "end", label: "Assessment Complete", config: {}, positionX: 1700, positionY: 250, metadata: {}, createdAt: now },
      
      // WF4: Audit Evidence Collection
      { id: "wf4-n1", workflowId: "wf4", typeId: "start", label: "Audit Initiated", config: {}, positionX: 100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n2", workflowId: "wf4", typeId: "ab-audits", label: "Load Audit Scope", config: { action: "query", filters: { auditId: "{{auditId}}", status: "planning" } }, positionX: 300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n3", workflowId: "wf4", typeId: "ab-controls", label: "Get In-Scope Controls", config: { action: "query", filters: { auditScope: "{{auditId}}" } }, positionX: 500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n4", workflowId: "wf4", typeId: "loop", label: "For Each Control", config: { iteratorVariable: "control", maxIterations: 50 }, positionX: 700, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n5", workflowId: "wf4", typeId: "human-task", label: "Collect Evidence", config: { assignee: "{{control.owner}}", title: "Submit Evidence for {{control.name}}", priority: "medium", description: "Upload evidence supporting control effectiveness" }, positionX: 900, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n6", workflowId: "wf4", typeId: "decision", label: "Evidence Sufficient?", config: { conditions: [{ field: "evidenceStatus", operator: "equals", value: "sufficient" }] }, positionX: 1100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n7", workflowId: "wf4", typeId: "email-notification", label: "Request Additional Evidence", config: { to: ["{{control.owner}}"], subject: "Additional Evidence Required - {{control.name}}" }, positionX: 1300, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf4-n8", workflowId: "wf4", typeId: "approval", label: "Auditor Review", config: { approvers: ["auditor@company.com"], requiredApprovals: 1 }, positionX: 1300, positionY: 300, metadata: {}, createdAt: now },
      { id: "wf4-n9", workflowId: "wf4", typeId: "ab-audits", label: "Update Audit Status", config: { action: "update", data: { evidenceStatus: "complete" } }, positionX: 1500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf4-n10", workflowId: "wf4", typeId: "end", label: "Collection Complete", config: {}, positionX: 1700, positionY: 200, metadata: {}, createdAt: now },
      
      // WF5: Vendor Risk Management
      { id: "wf5-n1", workflowId: "wf5", typeId: "start", label: "New Vendor Request", config: {}, positionX: 100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n2", workflowId: "wf5", typeId: "human-task", label: "Initial Questionnaire", config: { assignee: "vendor-manager@company.com", title: "Complete Vendor Assessment Questionnaire", priority: "medium", description: "Gather initial vendor information" }, positionX: 300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n3", workflowId: "wf5", typeId: "script", label: "Calculate Criticality", config: { language: "javascript", code: "return calculateVendorCriticality(vendor);" }, positionX: 500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n4", workflowId: "wf5", typeId: "decision", label: "Critical Vendor?", config: { conditions: [{ field: "criticality", operator: "greaterThan", value: 7 }] }, positionX: 700, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n5", workflowId: "wf5", typeId: "parallel-gateway", label: "Full Assessment", config: { branches: ["security", "financial", "compliance"] }, positionX: 900, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf5-n6", workflowId: "wf5", typeId: "human-task", label: "Security Review", config: { assignee: "security@company.com", title: "Vendor Security Assessment", priority: "high", description: "Evaluate vendor security posture" }, positionX: 1100, positionY: 50, metadata: {}, createdAt: now },
      { id: "wf5-n7", workflowId: "wf5", typeId: "human-task", label: "Financial Review", config: { assignee: "finance@company.com", title: "Vendor Financial Assessment", priority: "medium", description: "Evaluate vendor financial stability" }, positionX: 1100, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf5-n8", workflowId: "wf5", typeId: "human-task", label: "Compliance Check", config: { assignee: "compliance@company.com", title: "Vendor Compliance Assessment", priority: "medium", description: "Verify regulatory compliance" }, positionX: 1100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n9", workflowId: "wf5", typeId: "human-task", label: "Standard Review", config: { assignee: "vendor-manager@company.com", title: "Standard Vendor Review", priority: "low", description: "Complete standard vendor evaluation" }, positionX: 900, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf5-n10", workflowId: "wf5", typeId: "transform", label: "Compile Assessment", config: { mapping: { overallRisk: "{{avgScore}}", recommendation: "{{decision}}" } }, positionX: 1300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n11", workflowId: "wf5", typeId: "approval", label: "Final Approval", config: { approvers: ["procurement-head@company.com"], requiredApprovals: 1 }, positionX: 1500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf5-n12", workflowId: "wf5", typeId: "end", label: "Assessment Complete", config: {}, positionX: 1700, positionY: 250, metadata: {}, createdAt: now },
      
      // WF6: Policy Violation Response
      { id: "wf6-n1", workflowId: "wf6", typeId: "start", label: "Violation Detected", config: {}, positionX: 100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf6-n2", workflowId: "wf6", typeId: "ab-issues", label: "Log Violation", config: { action: "create", data: { type: "policy-violation", status: "new" } }, positionX: 300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf6-n3", workflowId: "wf6", typeId: "decision", label: "Severity Level?", config: { conditions: [{ field: "severity", operator: "equals", value: "critical" }] }, positionX: 500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf6-n4", workflowId: "wf6", typeId: "email-notification", label: "Alert Leadership", config: { to: ["ciso@company.com", "cro@company.com"], subject: "CRITICAL: Policy Violation Detected" }, positionX: 700, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf6-n5", workflowId: "wf6", typeId: "human-task", label: "Immediate Investigation", config: { assignee: "security-lead@company.com", title: "Investigate Critical Violation", priority: "critical", description: "Immediate investigation required" }, positionX: 900, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf6-n6", workflowId: "wf6", typeId: "human-task", label: "Standard Investigation", config: { assignee: "compliance-analyst@company.com", title: "Investigate Policy Violation", priority: "medium", description: "Review violation details and determine root cause" }, positionX: 700, positionY: 300, metadata: {}, createdAt: now },
      { id: "wf6-n7", workflowId: "wf6", typeId: "human-task", label: "Develop Response Plan", config: { assignee: "{{investigator}}", title: "Create Remediation Plan", priority: "high", description: "Develop corrective action plan" }, positionX: 1100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf6-n8", workflowId: "wf6", typeId: "approval", label: "Response Approval", config: { approvers: ["compliance-head@company.com"], requiredApprovals: 1 }, positionX: 1300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf6-n9", workflowId: "wf6", typeId: "ab-issues", label: "Update Violation Record", config: { action: "update", data: { status: "remediated", closedDate: "{{now}}" } }, positionX: 1500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf6-n10", workflowId: "wf6", typeId: "end", label: "Case Closed", config: {}, positionX: 1700, positionY: 200, metadata: {}, createdAt: now },
      
      // WF7: SOX Compliance Certification
      { id: "wf7-n1", workflowId: "wf7", typeId: "start", label: "Certification Period Start", config: {}, positionX: 100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf7-n2", workflowId: "wf7", typeId: "ab-controls", label: "Get SOX Controls", config: { action: "query", filters: { framework: "SOX", section: "404" } }, positionX: 300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf7-n3", workflowId: "wf7", typeId: "loop", label: "For Each Control", config: { iteratorVariable: "control", maxIterations: 200 }, positionX: 500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf7-n4", workflowId: "wf7", typeId: "human-task", label: "Control Owner Attestation", config: { assignee: "{{control.owner}}", title: "Certify Control: {{control.name}}", priority: "high", description: "Confirm control operated effectively during the period" }, positionX: 700, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf7-n5", workflowId: "wf7", typeId: "decision", label: "Exceptions Identified?", config: { conditions: [{ field: "hasExceptions", operator: "equals", value: true }] }, positionX: 900, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf7-n6", workflowId: "wf7", typeId: "ab-issues", label: "Log Exception", config: { action: "create", data: { type: "sox-exception", priority: "high" } }, positionX: 1100, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf7-n7", workflowId: "wf7", typeId: "approval", label: "Exception Review", config: { approvers: ["sox-coordinator@company.com"], requiredApprovals: 1 }, positionX: 1300, positionY: 150, metadata: {}, createdAt: now },
      { id: "wf7-n8", workflowId: "wf7", typeId: "transform", label: "Compile Certification", config: { mapping: { totalControls: "{{count}}", exceptions: "{{exceptionCount}}", certificationStatus: "{{status}}" } }, positionX: 1100, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf7-n9", workflowId: "wf7", typeId: "approval", label: "CFO Sign-off", config: { approvers: ["cfo@company.com"], requiredApprovals: 1, escalationDays: 3 }, positionX: 1300, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf7-n10", workflowId: "wf7", typeId: "approval", label: "CEO Sign-off", config: { approvers: ["ceo@company.com"], requiredApprovals: 1, escalationDays: 3 }, positionX: 1500, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf7-n11", workflowId: "wf7", typeId: "email-notification", label: "Certification Complete", config: { to: ["audit-committee@company.com", "external-auditor@firm.com"], subject: "SOX 404 Certification Complete" }, positionX: 1700, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf7-n12", workflowId: "wf7", typeId: "end", label: "Period Closed", config: {}, positionX: 1900, positionY: 250, metadata: {}, createdAt: now },
      
      // WF8: Incident Escalation Matrix
      { id: "wf8-n1", workflowId: "wf8", typeId: "start", label: "Incident Reported", config: {}, positionX: 100, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf8-n2", workflowId: "wf8", typeId: "ab-issues", label: "Create Incident", config: { action: "create", data: { type: "incident", status: "new" } }, positionX: 300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf8-n3", workflowId: "wf8", typeId: "script", label: "Classify Severity", config: { language: "javascript", code: "return classifyIncidentSeverity(incident);" }, positionX: 500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf8-n4", workflowId: "wf8", typeId: "decision", label: "P1 Critical?", config: { conditions: [{ field: "severity", operator: "equals", value: "P1" }] }, positionX: 700, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf8-n5", workflowId: "wf8", typeId: "parallel-gateway", label: "P1 Response", config: { branches: ["executive", "technical", "communications"] }, positionX: 900, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf8-n6", workflowId: "wf8", typeId: "email-notification", label: "Executive Alert", config: { to: ["ceo@company.com", "board@company.com"], subject: "P1 INCIDENT: Immediate Executive Attention Required" }, positionX: 1100, positionY: 0, metadata: {}, createdAt: now },
      { id: "wf8-n7", workflowId: "wf8", typeId: "human-task", label: "War Room Activation", config: { assignee: "incident-commander@company.com", title: "Activate Incident Response Team", priority: "critical", description: "Coordinate cross-functional response" }, positionX: 1100, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf8-n8", workflowId: "wf8", typeId: "webhook", label: "Alert PagerDuty", config: { url: "https://events.pagerduty.com/v2/enqueue", method: "POST" }, positionX: 1100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf8-n9", workflowId: "wf8", typeId: "decision", label: "P2 High?", config: { conditions: [{ field: "severity", operator: "equals", value: "P2" }] }, positionX: 900, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf8-n10", workflowId: "wf8", typeId: "human-task", label: "Manager Response", config: { assignee: "{{department.manager}}", title: "P2 Incident Response Required", priority: "high", description: "Coordinate department response" }, positionX: 1100, positionY: 300, metadata: {}, createdAt: now },
      { id: "wf8-n11", workflowId: "wf8", typeId: "human-task", label: "Team Lead Response", config: { assignee: "{{team.lead}}", title: "P3/P4 Incident Assignment", priority: "medium", description: "Assign and track resolution" }, positionX: 1100, positionY: 400, metadata: {}, createdAt: now },
      { id: "wf8-n12", workflowId: "wf8", typeId: "transform", label: "Track Resolution", config: { mapping: { responseTime: "{{duration}}", status: "{{currentStatus}}" } }, positionX: 1300, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf8-n13", workflowId: "wf8", typeId: "ab-issues", label: "Close Incident", config: { action: "update", data: { status: "resolved", resolvedDate: "{{now}}" } }, positionX: 1500, positionY: 250, metadata: {}, createdAt: now },
      { id: "wf8-n14", workflowId: "wf8", typeId: "end", label: "Incident Closed", config: {}, positionX: 1700, positionY: 250, metadata: {}, createdAt: now },
      
      // WF9: Regulatory Change Impact
      { id: "wf9-n1", workflowId: "wf9", typeId: "start", label: "Regulatory Update Received", config: {}, positionX: 100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n2", workflowId: "wf9", typeId: "human-task", label: "Initial Assessment", config: { assignee: "compliance-analyst@company.com", title: "Assess Regulatory Change", priority: "medium", description: "Review new/updated regulation for applicability" }, positionX: 300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n3", workflowId: "wf9", typeId: "decision", label: "Applicable?", config: { conditions: [{ field: "applicable", operator: "equals", value: true }] }, positionX: 500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n4", workflowId: "wf9", typeId: "ab-controls", label: "Identify Impacted Controls", config: { action: "query", filters: { regulatoryMapping: "{{regulationId}}" } }, positionX: 700, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n5", workflowId: "wf9", typeId: "ab-risks", label: "Assess Compliance Risk", config: { action: "create", data: { type: "regulatory-risk", source: "{{regulationId}}" } }, positionX: 900, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n6", workflowId: "wf9", typeId: "human-task", label: "Gap Analysis", config: { assignee: "compliance-lead@company.com", title: "Perform Gap Analysis", priority: "high", description: "Identify gaps between current state and new requirements" }, positionX: 1100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n7", workflowId: "wf9", typeId: "approval", label: "Implementation Plan Approval", config: { approvers: ["cco@company.com"], requiredApprovals: 1 }, positionX: 1300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n8", workflowId: "wf9", typeId: "loop", label: "For Each Gap", config: { iteratorVariable: "gap", maxIterations: 20 }, positionX: 1500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n9", workflowId: "wf9", typeId: "human-task", label: "Implement Change", config: { assignee: "{{gap.owner}}", title: "Implement: {{gap.description}}", priority: "high", description: "Execute remediation action" }, positionX: 1700, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf9-n10", workflowId: "wf9", typeId: "email-notification", label: "Not Applicable Notice", config: { to: ["compliance-team@company.com"], subject: "Regulatory Change - Not Applicable: {{regulationName}}" }, positionX: 500, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf9-n11", workflowId: "wf9", typeId: "end", label: "Complete", config: {}, positionX: 1900, positionY: 200, metadata: {}, createdAt: now },
      
      // WF10: Control Deficiency Remediation
      { id: "wf10-n1", workflowId: "wf10", typeId: "start", label: "Deficiency Identified", config: {}, positionX: 100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n2", workflowId: "wf10", typeId: "ab-issues", label: "Create Remediation Ticket", config: { action: "create", data: { type: "control-deficiency", status: "open" } }, positionX: 300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n3", workflowId: "wf10", typeId: "decision", label: "Material Weakness?", config: { conditions: [{ field: "classification", operator: "equals", value: "material-weakness" }] }, positionX: 500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n4", workflowId: "wf10", typeId: "email-notification", label: "Executive Notification", config: { to: ["cfo@company.com", "audit-committee@company.com"], subject: "MATERIAL WEAKNESS: Immediate Remediation Required" }, positionX: 700, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf10-n5", workflowId: "wf10", typeId: "approval", label: "Remediation Plan Approval", config: { approvers: ["cfo@company.com", "cio@company.com"], requiredApprovals: 2, escalationDays: 2 }, positionX: 900, positionY: 100, metadata: {}, createdAt: now },
      { id: "wf10-n6", workflowId: "wf10", typeId: "human-task", label: "Standard Remediation Plan", config: { assignee: "control-owner@company.com", title: "Develop Remediation Plan", priority: "medium", description: "Create action plan to address deficiency" }, positionX: 700, positionY: 300, metadata: {}, createdAt: now },
      { id: "wf10-n7", workflowId: "wf10", typeId: "human-task", label: "Execute Remediation", config: { assignee: "{{remediationOwner}}", title: "Execute Remediation Actions", priority: "high", description: "Implement approved remediation steps" }, positionX: 1100, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n8", workflowId: "wf10", typeId: "human-task", label: "Validate Fix", config: { assignee: "internal-audit@company.com", title: "Validate Remediation Effectiveness", priority: "high", description: "Test that remediation addressed the deficiency" }, positionX: 1300, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n9", workflowId: "wf10", typeId: "decision", label: "Validation Passed?", config: { conditions: [{ field: "validationResult", operator: "equals", value: "passed" }] }, positionX: 1500, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n10", workflowId: "wf10", typeId: "ab-issues", label: "Close Deficiency", config: { action: "update", data: { status: "closed", closedDate: "{{now}}" } }, positionX: 1700, positionY: 200, metadata: {}, createdAt: now },
      { id: "wf10-n11", workflowId: "wf10", typeId: "email-notification", label: "Reopen for Rework", config: { to: ["{{remediationOwner}}"], subject: "Remediation Validation Failed - Rework Required" }, positionX: 1500, positionY: 350, metadata: {}, createdAt: now },
      { id: "wf10-n12", workflowId: "wf10", typeId: "end", label: "Remediation Complete", config: {}, positionX: 1900, positionY: 200, metadata: {}, createdAt: now },
    ];
